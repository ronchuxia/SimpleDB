...
public class TupleDesc implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof TupleDesc) {
            ...
            if (tdItems.size() != td.numFields()) return false;
            for (int i = 0; i < tdItems.size(); ++i) {
                if (tdItems.get(i).fieldType != td.getFieldType(i)) return false;
            }
            return true;
        }
        else return false;
    ...
    public String toString() {
        ...
        for (int i = 0; i < tdItems.size() - 1; ++i) {
            result.append(tdItems.get(i).toString());
            result.append(", ");
        }
        result.append(tdItems.get(tdItems.size() - 1).toString());
