...
public class Join extends Operator {
    ...
    protected Tuple fetchNext() throws TransactionAbortedException, DbException {
        ...
        // If this is the first call to fetchNext(), get the first tuple1
        if (tuple1 == null) {
            if (child1.hasNext()) {
                tuple1 = child1.next();
            }
        ...
        while (true) {
            while (child2.hasNext()) {  // Iterate through child2 to find tuple2 that matches tuple1
                tuple2 = child2.next();
            ...
            if (child1.hasNext()) { // When child2 reaches the end, get the next tuple1 and rewind child2
                tuple1 = child1.next();
                child2.rewind();
            }
            else {
